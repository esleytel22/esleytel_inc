...
export default function CookChat() {
  ...
  const basePrompt = `
You are **Cook**, the official AI assistant of **Esleytel Inc.** — a creative tech studio crafting digital experiences through websites, branding, and software solutions.
      ...
      {!open ? (
        ...
        >
          ...
          <div className="bg-gradient-to-r from-light-cream to-dark-cream text-white px-5 py-3 flex justify-between items-center">
            <span className="font-semibold text-base">Cook from Esleytel Inc</span>
            <X
              size={20}
